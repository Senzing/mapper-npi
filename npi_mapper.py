        ...
        if rsltRecord['ENDPOINT']:
            ...
            if rsltRecord['ENDPOINT'].find('@') > 0:
                if rsltRecord['IS_AFFILIATE'] == 'Y':
                    ...
                    endpointList.append(
                        {'EMAIL_ADDRESS': rsltRecord['ENDPOINT']})
            ...
            # --jb: if not email its a website or other url
                ...
                if rsltRecord['IS_AFFILIATE'] == 'Y':
                    ...
                    endpointList.append(
                        {'WEBSITE_ADDRESS': rsltRecord['ENDPOINT']})
...
def map_othernames(inNPI):
    ...
    sql += ' from OTHERNAME where NPI = \'' + \
        str(inNPI) + '\' and "Provider Other Organization Name" <> \'NONE\''
...
def map_auth(input_row, npi_name):
    ...
    updateStat(auth_data['DATA_SOURCE'], 'NAME', '%s %s' % (input_row['Authorized Official First Name'], input_row['Authorized Official Last Name']))
    ...
    if input_row['Authorized Official Title or Position']:
        updateStat(auth_data['DATA_SOURCE'], 'TITLE', input_row['Authorized Official Title or Position'])
    ...
    if input_row['Authorized Official Telephone Number']:
        updateStat(auth_data['DATA_SOURCE'], 'PHONE', input_row['Authorized Official Telephone Number'])
...
def map_npi(input_row):
    ...
    if input_row['Provider Other Organization Name'] and input_row['Provider Other Organization Name'] != "NONE":
        if input_row['Provider Other Organization Name Type Code'] == '3':  # DBA
            ...
            updateStat(json_data['DATA_SOURCE'], 'NAME_ORG-DBA', input_row['Provider Other Organization Name'])
            ...
            updateStat(json_data['DATA_SOURCE'], 'NAME_ORG-FORMER', input_row['Provider Other Organization Name'])
            ...
            updateStat(json_data['DATA_SOURCE'], 'NAME_ORG-OTHER', input_row['Provider Other Organization Name'])
        else:
            updateStat(json_data['DATA_SOURCE'], 'NAME_ORG-UNKNOWN!', input_row['Provider Other Organization Name'])
    ...
    if input_row['Provider Other Last Name Type Code'] == '1' and input_row['Provider Other Last Name']:  # Former Name
        ...
        updateStat(json_data['DATA_SOURCE'], 'NAME_LAST/FIRST-FORMER', '%s, %s' % (input_row['Provider Other Last Name'], input_row['Provider Other First Name']))
        ...
        updateStat(json_data['DATA_SOURCE'], 'NAME_LAST/FIRST-PROFESSIONAL', '%s, %s' % (input_row['Provider Other Last Name'], input_row['Provider Other First Name']))
        if input_row['Provider Other Middle Name']:
        ...
        updateStat(json_data['DATA_SOURCE'], 'NAME_LAST/FIRST-DBA', '%s, %s' % (input_row['Provider Other Last Name'], input_row['Provider Other First Name']))
        if input_row['Provider Other Middle Name']:
        ...
        updateStat(json_data['DATA_SOURCE'], 'NAME_LAST/FIRST-OTHER', '%s, %s' % (input_row['Provider Other Last Name'], input_row['Provider Other First Name']))
        if input_row['Provider Other Middle Name']:
            json_data['OTHER_NAME_MIDDLE'] = input_row['Provider Other Middle Name']
        if input_row['Provider Other Name Prefix Text']:
            json_data['OTHER_NAME_PREFIX'] = input_row['Provider Other Name Prefix Text']
        if input_row['Provider Other Name Suffix Text']:
            json_data['OTHER_NAME_SUFFIX'] = input_row['Provider Other Name Suffix Text']
    else:
        updateStat(json_data['DATA_SOURCE'], 'NAME_LAST/FIRST-UNKNOWN!', '%s, %s' % (input_row['Provider Other Last Name'], input_row['Provider Other First Name']))

    # Addresses
    if input_row['Provider First Line Business Mailing Address']:
        updateStat(json_data['DATA_SOURCE'], 'ADDR_LINE1-MAILING', input_row['Provider First Line Business Mailing Address'])
        ...
        if input_row['Provider Second Line Business Mailing Address'] and input_row['Provider Second Line Business Mailing Address'] != "NONE":
            updateStat(json_data['DATA_SOURCE'], 'ADDR_LINE2-MAILING', input_row['Provider Second Line Business Mailing Address'])
    ...
    if input_row['Provider First Line Business Practice Location Address']:
        ...
        updateStat(json_data['DATA_SOURCE'], 'ADDR_LINE1-' + address_label, input_row['Provider First Line Business Practice Location Address'])
        json_data[address_label + '_ADDR_LINE1'] = input_row['Provider First Line Business Practice Location Address']
        if input_row['Provider Second Line Business Practice Location Address'] and input_row['Provider Second Line Business Practice Location Address'] != "NONE":
            updateStat(json_data['DATA_SOURCE'], 'ADDR_LINE2-' + address_label , input_row['Provider Second Line Business Practice Location Address'])
            json_data[address_label + '_ADDR_LINE2'] = input_row['Provider Second Line Business Practice Location Address']
        json_data[address_label + '_ADDR_CITY'] = input_row['Provider Business Practice Location Address City Name']
        json_data[address_label + '_ADDR_STATE'] = input_row['Provider Business Practice Location Address State Name']
        json_data[address_label + '_ADDR_POSTAL_CODE'] = input_row['Provider Business Practice Location Address Postal Code']
        json_data[address_label + '_ADDR_COUNTRY'] = input_row['Provider Business Practice Location Address Country Code (If outside U.S.)']

    #  Phone Numbers
    if input_row['Provider Business Mailing Address Telephone Number']:
        updateStat(json_data['DATA_SOURCE'], 'PHONE-MAILING-LOCATION', input_row['Provider Business Mailing Address Telephone Number'])
        json_data['MAILING-LOCATION_PHONE_NUMBER'] = input_row['Provider Business Mailing Address Telephone Number']
    if input_row['Provider Business Mailing Address Fax Number']:
        updateStat(json_data['DATA_SOURCE'], 'PHONE-MAILING-FAX', input_row['Provider Business Mailing Address Fax Number'])
        json_data['MAILING-FAX_PHONE_NUMBER'] = input_row['Provider Business Mailing Address Fax Number']
    if input_row['Provider Business Practice Location Address Telephone Number']:
        updateStat(json_data['DATA_SOURCE'], 'PHONE-BUSINESS-LOCATION', input_row['Provider Business Practice Location Address Telephone Number'])
        json_data['BUSINESS-LOCATION_PHONE_NUMBER'] = input_row['Provider Business Practice Location Address Telephone Number']
    if input_row['Provider Business Practice Location Address Fax Number']:
        updateStat(json_data['DATA_SOURCE'], 'PHONE-BUSINESS-FAX', input_row['Provider Business Practice Location Address Fax Number'])
        json_data['BUSINESS-FAX_PHONE_NUMBER'] = input_row['Provider Business Practice Location Address Fax Number']

    #  GENDER
    if input_row['Provider Gender Code']:
        updateStat(json_data['DATA_SOURCE'], 'GENDER', input_row['Provider Gender Code'])
    ...
    while looper < 16:
        if input_row['Provider License Number_' + str(looper)] and input_row['Provider License Number_' + str(looper)] != '=========':
            key1 = input_row['Provider License Number_' + str(
                looper)] + '|' + input_row['Provider License Number State Code_' + str(looper)]
            if key1 not in pLicNums_Mapped and check_id_value(input_row['Provider License Number_' + str(looper)].split()):
                ...
                updateStat('PROVIDER_LICENSE', input_row['Provider License Number State Code_' + str(looper)], input_row['Provider License Number_' + str(looper)])
        ...
        if input_row['Healthcare Provider Taxonomy Code_' + str(looper)] and input_row['Healthcare Provider Taxonomy Code_' + str(looper)] not in pTaxyCds_Mapped:
            ...
            updateStat(json_data['DATA_SOURCE'], 'TAXONOMY_CODE', input_row['Healthcare Provider Taxonomy Code_' + str(looper)])
        ...
        if input_row['Healthcare Provider Taxonomy Group_' + str(looper)] and input_row['Healthcare Provider Taxonomy Group_' + str(looper)] not in txnmyGrp_Mapped:
            ...
            updateStat(json_data['DATA_SOURCE'], 'TAXONOMY_GROUP', input_row['Healthcare Provider Taxonomy Group_' + str(looper)])
    ...
    while looper < 51:
        if input_row['Other Provider Identifier_' + str(looper)]:
            key1 = input_row['Other Provider Identifier Type Code_' + str(looper)] + '|' + input_row['Other Provider Identifier_' + str(
                looper)] + '|' + input_row['Other Provider Identifier State_' + str(looper)]
            if key1 not in opIDs_Mapped and check_id_value(input_row['Other Provider Identifier_' + str(looper)].split()):
                ...
                if input_row['Other Provider Identifier Type Code_' + str(looper)] == '05':
                    updateStat('PROVIDER_ID-MEDICARE-05', input_row['Other Provider Identifier State_' + str(looper)], input_row['Other Provider Identifier_' + str(looper)])
                    ...
                    opIDs.append({"MEDICAID_PROVIDER_ID": input_row['Other Provider Identifier_' + str(looper)], "MEDICAID_PROVIDER_STATE": input_row['Other Provider Identifier State_' + str(
                        looper)], "MEDICAID_PROVIDER_ISSUER": input_row['Other Provider Identifier Issuer_' + str(looper)]})
                else:
                    updateStat('PROVIDER_ID-OTHER-' + input_row['Other Provider Identifier Type Code_' + str(looper)], input_row['Other Provider Identifier State_' + str(looper)], input_row['Other Provider Identifier_' + str(looper)])
                    ...
                    opIDs.append({"OTHER_PROVIDER_ID": input_row['Other Provider Identifier_' + str(looper)], "OTHER_PROVIDER_STATE": input_row['Other Provider Identifier State_' + str(
                        looper)], "OTHER_PROVIDER_ISSUER": input_row['Other Provider Identifier Issuer_' + str(looper)]})
    ...
    if input_row['Provider Enumeration Date']:
        updateStat(json_data['DATA_SOURCE'], 'UNMAPPED: Provider Enumeration Date', input_row['Provider Enumeration Date'])
        json_data['Provider Enumeration Date'] = input_row['Provider Enumeration Date']
    if input_row['Last Update Date']:
        updateStat(json_data['DATA_SOURCE'], 'UNMAPPED: Last Update Date', input_row['Last Update Date'])
        json_data['Last Update Date'] = input_row['Last Update Date']
    if input_row['NPI Deactivation Reason Code']:
        updateStat(json_data['DATA_SOURCE'], 'UNMAPPED: NPI Deactivation Reason Code', input_row['NPI Deactivation Reason Code'])
        json_data['NPI Deactivation Reason Code'] = input_row['NPI Deactivation Reason Code']
    if input_row['NPI Deactivation Date']:
        updateStat(json_data['DATA_SOURCE'], 'UNMAPPED: NPI Deactivation Date', input_row['NPI Deactivation Date'])
        json_data['NPI Deactivation Date'] = input_row['NPI Deactivation Date']
    if input_row['NPI Reactivation Date']:
        updateStat(json_data['DATA_SOURCE'], 'UNMAPPED: NPI Reactivation Date', input_row['NPI Reactivation Date'])
    ...
    if input_row['Parent Organization LBN'] and input_row['Parent Organization LBN'] != "NONE":
        updateStat(json_data['DATA_SOURCE'], 'UNMAPPED: Parent Organization LBN', input_row['Parent Organization LBN'])
...
def loadDB(inFileSpec, inTabName):
    ...
    msgOut(0, '  Populating ' + inTabName +
           ' DB Table from reference file ', 'I', '', 0, 0)
    df = pandas.read_csv(inFileSpec, low_memory=False,
...
if __name__ == '__main__':
    ...
    argParser.add_argument('-i', '--sourceDir', dest='sourceDir', default='',
                           help='directory in which the source files are located', required=True)
    argParser.add_argument('-f', '--filePeriod', dest='filePeriod', default='',
                           help='the period portion of the NPPES file naming convention such as "20050523-20201108"', required=True)
    argParser.add_argument('-o', '--outFileDir', dest='outputFilePath', default='',
                           help='the file or directory to write the JSON files to', required=True)
    argParser.add_argument('-l', '--logFileName', dest='logFileName', default='',
    ...
    if (parms.filePeriod and len(parms.filePeriod) > 0) and (parms.sourceDir and len(parms.sourceDir) > 0):
        ...
        if os.path.isfile(npiDataFileSpec):
            msgOut(0, '        NPI Main data Input File Name : ' +
                   npiDataFileSpec, 'I', '', 0, 0)
            npiDataErrFileSpec = npiDataFileSpec + '.err'
        else:
            abortRun = 1
            msgOut(0, ' NPI Main data Input File Name  : ' + npiDataFileSpec +
                   '   <-  is not a file or does not exist', 'E', '', 2, 0)
        if os.path.isfile(onDataFileSpec):
            msgOut(0, '        Other Name reference data Input File Name : ' +
                   onDataFileSpec, 'I', '', 0, 0)
            onDataErrFileSpec = onDataFileSpec + '.err'
        else:
            abortRun = 1
            msgOut(0, ' Other Name reference data Input File Name  : ' +
                   onDataFileSpec + '   <-  is not a file or does not exist', 'E', '', 2, 0)
        if os.path.isfile(plDataFileSpec):
            msgOut(0, '        Practice Location reference data Input File Name : ' +
                   plDataFileSpec, 'I', '', 0, 0)
            plDataErrFileSpec = plDataFileSpec + '.err'
        else:
            abortRun = 1
            msgOut(0, ' Practice Location reference data Input File Name  : ' +
                   plDataFileSpec + '   <-  is not a file or does not exist', 'E', '', 2, 0)
        if os.path.isfile(epDataFileSpec):
            msgOut(0, '        Endpoint reference data Input File Name : ' +
                   epDataFileSpec, 'I', '', 0, 0)

        outputFilePath = os.path.abspath(parms.outputFilePath)
        if os.path.isdir(outputFilePath):
            outputOneFile = False
            msgOut(0, '        Output File Directory : ' +
                   outputFilePath, 'I', '', 0, 0)
        else:
            outputOneFile = True
            msgOut(0, '        Output File Name : ' +
                   outputFilePath, 'I', '', 0, 0)
        ...
        if not outputOneFile:
            ...
            Providers_outputFileSpec = outputFilePath + \
                'NPI_PROVIDERS_' + parms.filePeriod + '.json'
            Officials_outputFileSpec = outputFilePath + \
                'NPI_OFFICIALS_' + parms.filePeriod + '.json'
            Affiliations_outputFileSpec = outputFilePath + \
                'NPI_AFFILIATIONS_' + parms.filePeriod + '.json'
            Locations_outputFileSpec = outputFilePath + \
                'NPI_LOCATIONS_' + parms.filePeriod + '.json'

            #    Checking for existence of output files.  Delete if they exist.

            if not os.path.isfile(Providers_outputFileSpec):
                msgOut(0, '        NPI-PROVIDERS will be written to  : ' + 
                       Providers_outputFileSpec, 'I', '', 0, 0)
            else:
                msgOut(0, '        NPI-PROVIDERS output file exists and will be replaced  : ' + 
                       Providers_outputFileSpec, 'I', '', 0, 0)
                os.remove(Providers_outputFileSpec)

            if not os.path.isfile(Officials_outputFileSpec):
                msgOut(0, '        NPI-OFFICIALS will be written to  : ' +
                       Officials_outputFileSpec, 'I', '', 0, 0)
            else:
                msgOut(0, '        NPI-OFFICIALS output file exists and will be replaced  : ' +
                       Officials_outputFileSpec, 'I', '', 0, 0)
                os.remove(Officials_outputFileSpec)

            if not os.path.isfile(Affiliations_outputFileSpec):
                msgOut(0, '        NPI-AFFILIATIONS will be written to  : ' +
                       Affiliations_outputFileSpec, 'I', '', 0, 0)
            else:
                msgOut(0, '        NPI-AFFILIATIONS output file exists and will be replaced  : ' +
                       Affiliations_outputFileSpec, 'I', '', 0, 0)
                os.remove(Affiliations_outputFileSpec)

            if not os.path.isfile(Locations_outputFileSpec):
                msgOut(0, '        NPI-LOCATIONS will be written to  : ' +
                       Locations_outputFileSpec, 'I', '', 0, 0)
            else:
                msgOut(0, '        NPI-LOCATIONS output file exists and will be replaced  : ' +
                       Locations_outputFileSpec, 'I', '', 0, 0)
    ...
    if outputOneFile:
        ...
        Providers_outFile = open(
            Providers_outputFileSpec, 'w', encoding='utf-8')
        Officials_outFile = open(
            Officials_outputFileSpec, 'w', encoding='utf-8')
        Affiliations_outFile = open(
            Affiliations_outputFileSpec, 'w', encoding='utf-8')
        Locations_outFile = open(
            Locations_outputFileSpec, 'w', encoding='utf-8')
    ...
    if dbExists:  # --purge and reload
        msgOut(0, '  Purging existing temp DB for reference data :' +
               dbname, 'I', '', 0, 0)
        os.remove(dbname)
    else:
        msgOut(0, '  Initializing temp DB for reference data:' +
               dbname, 'I', '', 0, 0)
    ...
    msgOut(0, '     Total JSON rows produced              : ' +
           str(JSON_row_count), 'I', '', 0, 0)
    msgOut(0, '     NPI-Provider JSON rows produced       : ' +
           str(NPIProvider_row_count), 'I', '', 0, 0)
    msgOut(0, '     NPI-Officials JSON rows produced      : ' +
           str(NPIOfficials_row_count), 'I', '', 0, 0)
    msgOut(0, '     NPI-Locations JSON rows produced      : ' +
           str(NPILocations_row_count), 'I', '', 0, 0)
    msgOut(0, '     NPI-Affiliations JSON rows produced   : ' +
           str(NPIAffiliations_row_count), 'I', '', 0, 0)
    ...
    if shutDown:
        msgOut(0, ' Process aborted after ' +
               str(elapsedMins)+' minutes!', 'I', '', 0, 0)
    else:
        msgOut(0, ' Process completed successfully in ' +
               str(elapsedMins)+' minutes!', 'I', '', 0, 0)
